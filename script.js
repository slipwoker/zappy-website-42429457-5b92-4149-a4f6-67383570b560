document.addEventListener('DOMContentLoaded', function() {
  ...
  style.textContent = '.fade-in.visible, [data-animate="fade-in"].visible { opacity: 1 !important; transform: translateY(0) !important; }';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "נוישקה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '42429457-5b92-4149-a4f6-67383570b560',
                    name: data.name || '',
                    email: data.email || '',
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '42429457-5b92-4149-a4f6-67383570b560';
